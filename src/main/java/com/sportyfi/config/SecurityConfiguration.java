...
//    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
        .requestMatchers("/sportyfi/auth/**", "/sportyfi/*", "/sportyfi/matches/*", "/sportyfi/match/**", "/sportyfi/venues/*",
        		"/sportyfi/participants/*", "/sportyfi/match/update/**", "/sportyfi/profiles/**", "/sportyfi/profiles/update/**",
